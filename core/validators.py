...
healthcare_validators = {
    "medication_name": RegexValidator(
        ...
        message=_(
            "Medication name must be 2-100 characters, letters, numbers, spaces, hyphens, parentheses, and periods only."
        ),
    ),
    "insurance_number": RegexValidator(
        regex=r"^[A-Za-z0-9\-]{5,30}$",
        message=_(
            "Insurance number must be 5-30 characters, letters, numbers, and hyphens only."
        ),
    ),
}
