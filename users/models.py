...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    license_number = models.TextField(
        max_length=500, blank=True, help_text="Encrypted field"
    )
    ...
    def increment_failed_login_attempts(self):
        ...
        max_attempts = getattr(settings, "HIPAA_SETTINGS", {}).get(
            "MAX_LOGIN_ATTEMPTS", 3
        )
        lockout_duration = getattr(settings, "HIPAA_SETTINGS", {}).get(
            "LOCKOUT_DURATION", 15
        )
