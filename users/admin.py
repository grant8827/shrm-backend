...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = [
        ...
        'is_locked', 'last_login', 'date_joined'
    ]
    list_filter = [
    ...
    fieldsets = (
        ...
        ('Security', {
            'fields': ('must_change_password', 'failed_login_attempts', 'account_locked_until')
        }),
        ('Important Dates', {
    ...
    def unlock_accounts(self, request, queryset):
        ...
        self.message_user(
            request,
            f'Successfully unlocked {count} user account(s).'
        )
    ...
    def deactivate_users(self, request, queryset):
        ...
        self.message_user(
            request,
            f'Successfully deactivated {count} user account(s).'
        )
