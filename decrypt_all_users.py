...
def decrypt_all_users():
    ...
    for user in users:
        ...
        if user.first_name and (user.first_name.startswith('gAAAAAB') or user.first_name.startswith('Z0FBQUFBQnB')):
            try:
        ...
        if user.last_name and (user.last_name.startswith('gAAAAAB') or user.last_name.startswith('Z0FBQUFBQnB')):
            try:
        ...
        if user.phone and (user.phone.startswith('gAAAAAB') or user.phone.startswith('Z0FBQUFBQnB')):
            try:
        ...
        if user.license_number and (user.license_number.startswith('gAAAAAB') or user.license_number.startswith('Z0FBQUFBQnB')):
            try:
