...
class PaymentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Payment
        fields = [
            'id', 'bill', 'amount', 'payment_date', 'payment_method',
            'transaction_id', 'notes', 'recorded_by', 'recorded_by_name',
            'created_at'
        ]
...
class BillSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'title', 'description', 'amount', 'amount_paid', 'balance_remaining',
            'status', 'issue_date', 'due_date', 'paid_date',
            'payment_method', 'transaction_id', 'notes',
            'is_paid', 'is_overdue', 'payments',
            'created_at', 'updated_at'
        ]
        read_only_fields = [
            'id', 'created_at', 'updated_at', 'balance_remaining',
            'is_paid', 'is_overdue', 'patient_name', 'created_by_name'
        ]
...
class BillCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Bill
        fields = [
            'patient', 'title', 'description', 'amount',
