...
class SOAPNote(models.Model):
    ...
    session_duration = models.IntegerField(help_text="Duration in minutes", null=True, blank=True)
    ...
    def __str__(self):
        return f"SOAP Note - {self.patient.get_full_name()} - {self.session_date.date()}"
